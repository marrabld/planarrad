...
#ifndef _JUDE_S3_PLUCKER_H
#define _JUDE_S3_PLUCKER_H
...
public:
  ...
  Plucker(const Vec3D& from, const Vec3D& to) : 
  ...
  static double sideOperator(const Plucker& a, const Plucker& b) {
    return a.a0*b.a4 + a.a1*b.a5 + a.a2*b.a3 + a.a3*b.a2 + a.a4*b.a0 + a.a5*b.a1;
  }

  const Plucker& operator=(const Plucker& p) {
    a0 = p.a0;
    a1 = p.a1;
    a2 = p.a2;
    a3 = p.a3;
