...
#ifndef _WLTOOL_GUI_CHART_HOCR_TIME_H
#define _WLTOOL_GUI_CHART_HOCR_TIME_H
...
class Chart_HOCR_Time : public Chart_Time {
...
private:
  ...
  ChartLineData2D line_blue;
  ChartLineData2D line_green;
  ChartLineData2D line_red;
...
public:
  ...
  Chart_HOCR_Time(const JString& title_postfix, chart_type ct, bool show_key, QWidget *p=0);
...
#endif // _WLTOOL_GUI_CHART_HOCR_TIME_H
