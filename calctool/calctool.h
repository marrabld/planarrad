...
class CalcTool : public Tool {
  ...
  bool columnWeightedHistogram(const JString& table_src, const JString& table_targ, const JString& src_col, const JString& weight_col, const JString& bin_size, const JString& bin_count);
  ...
  bool sumGreaterThan(const JString& table_val, const JString& table_sum, const JString& value, const JString& table_out);
